...
type TransportSettings struct {
	...
	// Download requests can override this per-request via RequestBuilder.SetTimeout(0).
	...
	// InsecureSkipVerify is true (InsecureSkipVerify takes precedence). When nil
	// the transport uses the system certificate pool, which trusts Microsoft's
	// public software-download endpoints without extra configuration.
